...
<div class="col-1"><img src="../Product Images/joint-max-ds-double-strength-120-chewable-tablets-24.png" width="200" alt="Joint Max Double Strength Chewable tablets for Dogs"/>
...
<table border="0" class="ingredients">
  <tbody>
    ...
    <tr class="even">
      ...
      <td class="align-right">530 mg</td>
    </tr>
    <tr>
      <td>Chondroitin Sulfate (Porcine Source)</td>
      <td class="align-right">420 mg</td>
    </tr>
    <tr class="even">
      <td>Ascorbic Acid (Vitamin C)</td>
      <td class="align-right">25 mg</td>
    </tr>
    <tr>
      <td>Cysteine</td>
      <td class="align-right">15 mg</td>
    </tr>
    <tr class="even">
      <td>Manganese</td>
    ...
    <tr>
     ...
     <tr>
      <td colspan="2" class="even"><strong>Inactive Ingredients:</strong>  Animal Liver Meal, and Beef Flavor (non-bovine source).</td>
    </tr>
  </tbody>
</table>
<div class="sidebar">
<h2>Testimonials:</h2>
<figure>
<blockquote>These tablets are gobbled up by my 11 year old lab and I can see the difference in her movement. I've tried two other joint supplements and this one has proven the most effective and "least likely to be spit out" of them all!</blockquote>
<figcaption>-DLC</figcaption>
...
<div class="col-2">
  <h1>Joint MAX<sup><sup>&reg;</sup></sup> &#124; Double Strength Chewable Tablets</h1>
  
  <p>Joint MAX RS helps ease stiffness and promotes healthy cartilage and joints. Glucosamine and Chondroitin work together to promote improved joint health by strengthening your dog's cartilage. It also contains Vitamin C, Zinc and N-Acetyl-Cysteine for added joint healing. Recommended for dogs that show moderate signs of joint disease.</p>
  
  <p>You should use this if your pet is experiencing one of these symptoms:</p>
  
  <ul>
    <li>Stiffness after exercise</li>
    <li>Difficulty jumping or climbing stairs</li>
    <li>Walking more slowly</li>
    <li>Hopping instead of running</li>
  </ul>
  
  <p>Joint MAX can be used alone or in combination with prescription drugs like Rimadyl<sup>&reg;</sup>, Etogesic<sup>&reg;</sup>, or Deramaxx<sup>&reg;</sup> and can eventually help decrease the need for these drugs.</p>
  
  <table class="numbers">
  <tbody>
    <tr>
      <td>120 Chewable Tablets (120 Doses)</td>
      <td>#JMDS120CH</td>
      <td>UPC: 814087005052</td>
    </tr>
    <tr>
      <td>250 Chewable Tablets (250 Doses)</td>
      <td>#JMDS250CH</td>
      <td>UPC: 814087005069</td>
    </tr>
  </tbody>
</table>
  ...
  <p><h2>Administration:</h2>
   Feed chewable tablets directly to dog or crumble over food. Administer with or after a meal to reduce incidence of gastrointestinal upset.
   </p>
  ...
  <p>After 3 weeks loading dose, if positive results are seen, reduce to maintenance dose. Since each pet's body is different, results may take longer in some pets. If positive results are not seen, continue loading dose. Joint MAX<sup>&reg;</sup> Double Strength Chewable Tablets can also be used long term on a daily basis for normal dogs to help support joint health.</p>
  ...
  <p><h2>Product Website:</h2><a href="#" class="muted"> www.jointmax.com</a></p> 
  ...
  <ul class="downloads muted second-ul">
    <li><a href="#">Joint MAX<sup>&reg;</sup> DS (ALL) JPG</a></li>
    <li><a href="#">Joint MAX<sup>&reg;</sup> DS (120 Tablets) JPG</a></li>
    <li><a href="#">Joint MAX<sup>&reg;</sup> DS (250 Tablets) JPG</a></li>
    <li><a href="#">Download the full PHS line JPG(26.9 MB)</a></li>
